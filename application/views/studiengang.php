...
<table>
	<tr>
		...
		<td><?php echo form_input(array("name" => "stgKBez", "value" => $stg->stgKBez)); ?></td>
	</tr>
	<tr>
		<td><label for="stgBez">Voller Studiengangsname:</label></td>
		<td><?php echo form_input(array("name" => "stgBez", "value" => $stg->stgBez)); ?></td>
	</tr>
	<tr>
...
<table>
	<tr>
		...
		<td><?php echo form_input(array("name" => "stgStgL", "value" => $stg->stgStgL)); ?></td>
	</tr>
	<tr>
		<td><label for="stgStgLImage">Bild der Studiengangsleitung:</label></td>
		<td>
	...
	<tr>
		...
		<td><?php echo form_input(array("name" => "stgStgA", "value" => $stg->stgStgA)); ?></td>
	</tr>
	<tr>
		<td><label for="stgStgAImage">Bild der Studiengangsasistenz:</label></td>
		<td>
...
<table>
	<tr>
		<td class="editorLabel"><label for="stgHighlights">Zitat der Studiengangsleitung:</label></td>
		<td><?php echo form_textarea(array("name" => "stgQuote", "value" => $stg->stgQuote)); ?></td>
	</tr>
	<tr>
		<td class="editorLabel"><label for="stgStudent1Quote">Zitat des 1. Studenten: </label></td>
		<td><?php echo form_textarea(array("name" => "stgStudent1Quote", "value" => $stg->stgStudent1Quote)); ?></td>
	</tr>

	<tr>
		<td><label for="stgStudent1Image">Bild für Zitat des 1. Studenten:</label></td>
		<td>
	...
	<tr>
		<td class="editorLabel"><label for="stgStudent2Quote">Zitat des 2. Studenten:</label></td>
		<td><?php echo form_textarea(array("name" => "stgStudent2Quote", "value" => $stg->stgStudent2Quote)); ?></td>
	</tr>

	<tr>
		<td><label for="stgStudent2Image">Bild für Zitat des 2. Studenten:</label></td>
		<td>
...
<table>
	<tr>
		<td class="editorLabel"><label for="stgHighlights">Highlights:</label></td>
		<td><?php echo form_textarea(array("name" => "stgHighlights", "value" => $stg->stgHighlights)); ?></td>
	</tr>
...
<table>
	<tr>
		<td><label for="stgFStudienplaetze">Anzahl der Studienpl&auml;tze:</label></td>
		<td><?php echo form_input(array("name" => "stgFStudienplaetze", "value" => $stg->stgFStudienplaetze)); ?></td>
	</tr>
	<tr>
		<td><label for="stgFBewerbungsmodus">Bewerbungsmodus:</label></td>
		<td><?php echo form_input(array("name" => "stgFBewerbungsmodus", "value" => $stg->stgFBewerbungsmodus)); ?></td>
	</tr>
	<tr>
		<td><label for="stgFDauer">Dauer:</label></td>
		<td><?php echo form_input(array("name" => "stgFDauer", "value" => $stg->stgFDauer)); ?></td>
	</tr>
	<tr>
		<td><label for="stgFAkadGrad">Akademischer Grad:</label></td>
		<td><?php echo form_input(array("name" => "stgFAkadGrad", "value" => $stg->stgFAkadGrad)); ?></td>
	</tr>
	<tr>
		<td><label for="stgFUnterrichtssprache">Unterrichtssprache:</label></td>
		<td><?php echo form_input(array("name" => "stgFUnterrichtssprache", "value" => $stg->stgFUnterrichtssprache)); ?></td>
	</tr>
	<tr>
		<td><label for="stgFBesonderheit">Besonderheit:</label></td>
		<td><?php echo form_input(array("name" => "stgFBesonderheit", "value" => $stg->stgFBesonderheit)); ?></td>
	</tr>
	<tr>
		<td><label for="stgFAuslandsaufenthalt">Auslandsaufenthalt:</label></td>
		<td><?php echo form_input(array("name" => "stgFAuslandsaufenthalt", "value" => $stg->stgFAuslandsaufenthalt)); ?></td>
	</tr>
	<tr>
		<td><label for="stgFKosten">Kosten:</label></td>
		<td><?php echo form_input(array("name" => "stgFKosten", "value" => $stg->stgFKosten)); ?></td>
	</tr>
	<tr>
...
<table>
	<tr>
		<td class="editorLabel"><label for="stgBFelder">Berufsfelder:</label></td>
		<td><?php echo form_textarea(array("name" => "stgBFelder", "value" => $stg->stgBFelder)); ?></td>
	</tr>
	<tr>
...
<table>
	<tr>
		<td><label for="stgGridViewImage">Bild f&uuml;r die &Uuml;bersicht:</label></td>
		<td>
...
<div id="status"><?php echo $systemMessages; ?>&nbsp;&nbsp;<label for="freigabe" style="font-weight: bold">Freigeben:&nbsp;</label><?php echo form_checkbox(array("name" => "freigabe", "value" => "1", "checked" => ($stg->freigabe ? "checked": "") )); ?>&nbsp;&nbsp;<?php echo form_button(array("name" => "submit", "content" => "Speichern", "class" => "button", "onClick" => "javascript: save();"))?></div>
