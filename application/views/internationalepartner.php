...
<div id="status"><?php echo $systemMessages; ?><?php echo form_button(array("name" => "submit", "content" => "Speichern", "class" => "button", "onClick" => "javaphsipt: addIndizes(); $('form#form input[type=\'submit\']').trigger('click');"))?></div>
