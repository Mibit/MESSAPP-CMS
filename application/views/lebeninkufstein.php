...
<div id="status"><?php echo $systemMessages; ?><?php echo form_button(array("name" => "submit", "content" => "Speichern", "class" => "button", "onClick" => "javalikipt: addIndizes(); $('form#form input[type=\'submit\']').trigger('click');"))?></div>
