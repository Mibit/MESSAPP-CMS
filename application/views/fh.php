...
<div id="status"><?php echo $systemMessages; ?><?php echo form_button(array("name" => "submit", "content" => "Speichern", "class" => "button", "onClick" => "javaphsipt: $('form#form input[type=\'submit\']').trigger('click');"))?></div>
